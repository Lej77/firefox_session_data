//! Implements a simple Typst world so that we can compile typst documents.
//!
//! # References
//!
//! Inspired by code at:
//! [tfachmann/typst-as-library: Simple demo that demonstrates how to use typst as a library in Rust](https://github.com/tfachmann/typst-as-library/tree/af32c13d439d8f4ecc89810444883676135ebc9a)
//!
//! Typst was also used by:
//! [Generating 1 Million PDFs in 10 Minutes (using Rust on AWS Lambda) : r/rust](https://www.reddit.com/r/rust/comments/1k6qh0e/generating_1_million_pdfs_in_10_minutes_using/)
//! - Article: <https://www.ersteiger.com/posts/rendering-one-million-pdfs/>
//! - Links to code at: <https://github.com/rkstgr/papermake-aws>
//! - Typst code is at: <https://github.com/rkstgr/papermake>
//! - No license! So don't inspect the code unless this changes.
...
impl TypstWrapperWorld {
    pub fn new(root: String, source: String) -> Self {
        ...
        Self {
            ...
            time: if cfg!(all(target_family = "wasm", target_os = "unknown")) {
...
impl typst::World for TypstWrapperWorld {
    ...
    fn today(&self, offset: Option<i64>) -> Option<Datetime> {
        ...
        let time = now.checked_to_offset(offset)?;
